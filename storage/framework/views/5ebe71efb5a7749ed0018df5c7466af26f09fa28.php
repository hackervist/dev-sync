...
<ol class='breadcrumb'>
		...
		<li><a class='active'  href='forums'>Forum</a></li> 
</ol>
				        	...
				        	<li>
				        		<a class="discussion_list" href="/<?php echo e(Config::get('chatter.routes.home')); ?>/<?php echo e(Config::get('chatter.routes.discussion')); ?>/<?php echo e($discussion->category->slug); ?>/<?php echo e($discussion->slug); ?>">
					        		...
					        		<div class="chatter_middle">
					        			...
					        			<span class="chatter_middle_details"><?php echo app('translator')->get('chatter::messages.discussion.posted_by'); ?> <span data-href="/user"><?php echo e(ucfirst($discussion->user->{Config::get('chatter.user.database_field_with_user_name')})); ?></span> <?php echo e(\Carbon\Carbon::createFromTimeStamp(strtotime($discussion->created_at))->diffForHumans()); ?></span>
	...
	<div id="new_discussion">
    	...
    	<form id="chatter_form_editor" action="/<?php echo e(Config::get('chatter.routes.home')); ?>/<?php echo e(Config::get('chatter.routes.discussion')); ?>" method="POST">
        	...
        	<div id="editor">
				...
				<?php elseif($chatter_editor == 'trumbowyg'): ?>
					<textarea class="trumbowyg" name="body" placeholder="<?php echo app('translator')->get('chatter::messages.editor.tinymce_placeholder'); ?>"><?php echo e(old('body')); ?></textarea>
				<?php endif; ?>
    		</div>
            ...
            <div id="new_discussion_footer">
            	<input type='text' id="color" name="color" /><span class="select_color_text"><?php echo app('translator')->get('chatter::messages.editor.select_color_text'); ?></span>
            	<button id="submit_discussion" class="btn btn-success pull-right"><i class="chatter-new"></i> <?php echo app('translator')->get('chatter::messages.discussion.create'); ?></button>
            	<a href="/<?php echo e(Config::get('chatter.routes.home')); ?>" class="btn btn-default pull-right" id="cancel_discussion"><?php echo app('translator')->get('chatter::messages.words.cancel'); ?></a>
