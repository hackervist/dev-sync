	...
	<ol class='breadcrumb'>
		...
		<div id="myModal" class="modal">
		  	...
		  	<div class="modal-content">
			    ...
			    <form class="form" role="form" method="POST" action="<?php echo e(url('/inviteMail')); ?> ">
...
<?php echo $__env->yieldContent('layouts.scripts'); ?>
	    ...
	    <!-- name Form Input -->
			        ...
			        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
			            ...
			            <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" id="txtName">
			        ...
			        <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
			            ...
			            <input type="text" class="form-control" name="description" value="<?php echo e(old('description')); ?>" id="txtDesc">
