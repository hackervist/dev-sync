                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            <td>
                             <a href="/marketing-image/{{row.Id}}"><img src="/imgs/marketing/thumbnails/thumb-{{row.Name + '.' + row.Ext}}"></a>
                            </td>
                            <td>
                                <a href="/marketing-image/{{row.Id}}">{{row.Name}}</a>
                            </td>
                            <td>
                                {{ row.Weight }}
                            </td>
                            ...
                            <td ><a href="/marketing-image/{{row.Id}}/edit">
            ...
            <div class="row">
                ...
                <ul class="pagination pull-right">
                    ...
                    <li v-if="checkUrlNotNull(next_page_url)">
                        <a @click="getData(next_page_url)">next</a>
                    </li>
